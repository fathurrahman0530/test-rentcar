...
namespace App\Repositories\Dashboard\Setting\Company;
...
class CompanyRepositoryImplement implements CompanyRepository
{
    // get data
    ...
    public function update($key, $uuid, $data)
    {
        ...
        $response = Company::where($key, $uuid)->update($data);
