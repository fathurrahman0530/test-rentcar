...
@section('btn.nav')
    <a href="{{ route('db.spk.penyewaan') }}" class="btn btn-secondary" style="margin-right: 10px">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Detail Penyewaan J{{ $data->no_spk }}</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            ...
                                            <input type="text" name="masa_sewa" id="masa_sewa" class="form-control" value="{{ $selisih }} Hari" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ $data->fullname }}" name="fullname" id="fullname" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value="{{ $data->tmpt_lahir }}" name="tmpt_lahir" id="tmpt_lahir" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="alamat" id="alamat" class="form-control" cols="15" rows="5" readonly>{{ $data->alamat }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="pekerjaan" value="{{ $data->pekerjaan }}" id="pekerjaan" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="email">Email</label>
                                        <input type="email" name="email" value="{{ $data->email }}" id="email" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <a href="https://wa.me/62{{ substr($data->notelp, 1) }}" target="_blank">{{$data->notelp}}</a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="notelp_kerabat">No. Telephone Kerabat</label><br>
                                        <a href="https://wa.me/62{{ substr($data->notelp_kerabat, 1) }}" target="_blank">{{$data->notelp_kerabat}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div id="penyelesaian" class="modal fade modal-penyelesaian" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('db.spk.penyewaan.penyelesaian') }}" method="post">
                    @csrf
                    <input type="hidden" name="act" value="Penyelesaian">
                    <input type="hidden" name="uuid" value="{{ $data->idSpks }}">
                    <input type="hidden" name="uuid_unit" value="{{ $data->uuid_unit }}">
                    <input type="hidden" name="status" value="T">
                    <input type="hidden" name="status_unit" value="RD">
                    <input type="hidden" id="km_awal" name="km_awal" value="{{ $data->km_awal }}">
                    <input type="hidden" id="tgl_kembali" name="tgl_kembali" value="{{ $data->tgl_kembali }}">
                    <input type="hidden" id="jam_kembali" name="jam_kembali" value="{{ $data->jam_kembali }}">
                    <input type="hidden" id="harga_unit" name="harga_unit" value="{{ $car[0]->harga }}">
                    <input type="hidden" id="old_tunggakan" name="old_tunggakan" value="{{ $data->total_payment - $data->store_payment }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-6">
                                ...
                                <input type="number" name="total_pembayaran" id="total_pembayaran" class="form-control" value="{{ $data->total_payment }}" readonly>
                            </div>
                            <div class="col-lg-6">
                                <label for="status_pembayaran">Status Pembayaran</label>
                                <input type="text" name="status_pembayaran" id="status_pembayaran" class="form-control"
                                       value="{{ $data->total_payment - $data->store_payment == 0 ? 'Lunas' : 'Belum Lunas' }}" readonly>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-lg-6">
                                <label for="sisa_tagihan">Sisa Tagihan</label>
                                <input type="number" name="sisa_tagihan" id="sisa_tagihan" class="form-control" value="{{ $data->total_payment - $data->store_payment }}"
                                       readonly>
                            </div>
                            <div class="col-lg-6">
    ...
    <div id="perpanjang" class="modal fade" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('db.spk.penyewaan.perpanjang') }}" method="post">
                    @csrf
                    <input type="hidden" name="act" value="Perpanjang">
                    <input type="hidden" name="uuid" value="{{ $data->idSpks }}">
                    <input type="hidden" name="hr_unit" value="{{ $car[0]->harga }}">
                    <input type="hidden" name="old_total_pay" value="{{ $data->total_payment }}">
                    <input type="hidden" name="old_tgl_kembali" value="{{ $data->tgl_kembali }}">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <label for="tgl_ambil_perpanjang">Tanggal Kembali</label>
                                <input type="date" name="tgl_ambil_perpanjang" id="tgl_ambil_perpanjang" class="form-control" value="{{ $data->tgl_ambil }}" readonly>
                            </div>
                            <div class="col-lg-6">
