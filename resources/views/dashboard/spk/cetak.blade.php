...
//     dd($proses);
    ...
    @endphp
    @foreach ($dCar as $key => $value)
    <div class="page-1" style="page-break-after: always">
        <div id="header">
            <center>
                <table width="75%" style="margin-left: -165px">
                    <tr>
                        <td rowspan="5" width="30%" style="text-align: center"><img src="{{ asset('img') }}/logo/{{ $company->logo }}" alt="" width="65%"></td>
                    </tr>
                    <tr>
                        <td style="text-align: center" width="70%">{{ $company->name }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: center" width="70%">{{ $company->alamat }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: center" width="70%">Tlp( 0411 ){{ $company->telp }}, Mobile : {{ $company->mobile_1
                            }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: center" width="70%">Email : {{ $company->email }}</td>
                    </tr>
                </table>
        ...
        <div class="content" style="margin-top: 120px">
            ...
            <table cellpadding="5px" style="margin-top: -20px">
                ...
                <tr>
                    <td width="55%">Nama</td>
                    <td width="5px">:</td>
                    <td>{{ $penyewa->fullname }}</td>
                </tr>
                <tr>
                    <td width="55%">Tempat / Tanggal Lahir</td>
                    <td width="5px">:</td>
                    <td>{{ $penyewa->tmpt_lahir }} / {{ $penyewa->tgl_lahir }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="5px">:</td>
                    <td>{{$penyewa->notelp}}</td>
                </tr>
                <tr>
                    <td width="55%">No. Hp Kerabat</td>
                    <td width="5px">:</td>
                    <td>{{$penyewa->notelp_kerabat}}</td>
                </tr>
            </table>
            ...
            <table cellpadding="5px">
                <tr>
                    ...
                    <td width="5px">:</td>
                    <td>{{ $value->name }}</td>
                    <td>No. Polisi : <u>{{ $value->plat }}</u></td>
                    <td>Tahun : <u>{{ $value->tahun }}</u></td>
                </tr>
                <tr>
                    @php
                    ...
                    <td width="5px">:</td>
                    <td>Rp. {{ number_format(intval($data['spk']->total_payment) / intval($selisi->format("%d")), 0,',','.') }} / Hari</td>
                    <td colspan="2">Keluar &nbsp;&nbsp;&nbsp;: <u>{{ date('d/m/Y', strtotime($data['spk']->tgl_ambil)) }} {{
                            $data['spk']->jam_ambil }} {{ $company->zona }}</u></td>
                </tr>
                <tr>
                    <td width="210px">Masa Sewa</td>
                    <td>:</td>
                    <td>{{ $selisi->format("%d") }} Hari</td>
                    <td colspan="2">Kembali : <u>{{ date('d/m/Y', strtotime($data['spk']->tgl_kembali)) }} {{
                            $data['spk']->jam_kembali }} {{ $company->zona }}</u>
                    </td>
                </tr>
                <tr>
                    <td width="210px">Tujuan Penyewaan</td>
                    <td width="5px">:</td>
                    <td>{{ $data['spk']->tujuan }}</td>
                    <td colspan="2">Kategori Penyewaan : <u>{{ $data['spk']->kat_pemakaian == 'LK' ? " Lepas Kunci"
                            : "Dengan Drive" }}</u></td>
                </tr>
                <tr>
                    <td width="210px">Jaminan Penyewaan</td>
                    <td width="5px">:</td>
                    <td colspan="3">{{ $data['spk']->jaminan }}</td>
                </tr>
            </table>
            <p><b>Ket.</b></p>
            <ul>
            ...
            <table width="100%" cellpadding="5px" style="border-collapse: collapse; border: 1px solid #000;">
                ...
                <tbody>
                    <tr style="border: 1px solid #000;">
                        <td style="border: 1px solid #000;">Rp. {{ number_format($data['spk']->total_payment, 0,',','.') }}</td>
                        <td style="border: 1px solid #000;">Rp. {{ number_format($data['spk']->store_payment, 0,',','.') }}</td>
                        <td style="border: 1px solid #000;">Rp. {{ number_format($data['spk']->total_payment - $data['spk']->store_payment, 0,',','.') }}
                        </td>
                        <td style="border: 1px solid #000;">{{ $data['spk']->total_payment - $data['spk']->store_payment == 0 ?
            ...
            <table width="100%" cellpadding="5px">
                <tr>
                    <td width="33.3%" align="center">{{ $company->name }} <br> Diketahui,</td>
                    <td width="33.3%"></td>
                    <td width="33.3%" align="center">Gowa, Tanggal {{ date('d/m/Y', strtotime($request['tgl_pesan'])) }}<br>Yang Pembuat Pernyataan</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td width="33.3%" align="center">( {{ $proses->fullname }} )</td>
                    <td width="33.3%" align="center">(...............................)</td>
                    <td width="33.3%" align="center">( {{ $penyewa->fullname }} )</td>
                </tr>
                <tr>
    ...
    <div class="page-2" style="page-break-before: always">
        <div class="content" style="margin-top: 120px">
            ...
            <table width="100%" cellpadding="5px">
                <tr>
                    <td width="36%"><b>Kendaraan</b> : {{ $value->name }}</td>
                    <td width="30%"><b>No. Polisi</b> : {{ $value->plat }}</td>
                    <td width="34%"><b>Tanggal</b> : Gowa, {{ date('d/m/Y', strtotime($request['tgl_pesan'])) }}</td>
                </tr>
            </table>
                ...
                <tbody>
                    <tr>
                        <td style="border: 1px solid #000;" align="center" width="50px" rowspan="7">
                            <img src="{{ asset('img') }}/bahan_spk/depan.jpg" alt="" width="75%">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="border: 1px solid #000;" align="center" width="50px" rowspan="7">
                            <img src="{{ asset('img') }}/bahan_spk/belakang.jpg" alt="" width="75%">
                        </td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #000;"></td>
                    ...
                    <tr>
                        <td style="border: 1px solid #000;" align="center" width="50px" rowspan="7">
                            <img src="{{ asset('img') }}/bahan_spk/kanan.jpg" alt="" width="75%" height="150px">
                        </td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #000;"></td>
                    ...
                    <tr>
                        <td style="border: 1px solid #000;" align="center" width="250px" rowspan="7">
                            <img src="{{ asset('img') }}/bahan_spk/kiri.jpg" alt="" width="75%" height="150px">
                        </td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #000;"></td>
            ...
            <table width="100%" cellpadding="4px" style="border-collapse: collapse; border: 1px solid #000;">
                <tr>
                    ...
                    <td style="border: 1px solid #000;" align="center" rowspan="5" width="28%">
                        <img src="{{ asset('img') }}/bahan_spk/indikator_fuel.jpg" alt="" width="75%">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #000;" align="center"></td>
                    <td style="border: 1px solid #000;" align="center"></td>
                    <td style="border: 1px solid #000;">Km. Ambil : {{ $request['km_ambil'] }}</td>
                </tr>
                <tr>
            ...
            <table width="100%" cellpadding="5px">
                <tr>
                    <td align="center" width="50%">( {{ $proses->fullname }} )</td>
                    <td align="center" width="50%">( {{ $penyewa->fullname }} )</td>
                </tr>
                <tr>
